...
const config = {
  ...
  url: 'https://albarodriguezsalvador.github.io',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/ehds-challenge/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'albarodriguezsalvador', // Usually your GitHub org/user name.
  projectName: 'ehds-challenge', // Usually your repo name.
