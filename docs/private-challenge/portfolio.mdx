...
* **Para profesionales sanitarios:** Validación de la **suficiencia clínica** de la IA mediante **cuestionarios (HCP)**, asegurando que la herramienta actúe como un apoyo en la detección temprana de descompensaciones sin aumentar la carga administrativa del médico.  
